...
INSERT INTO `questions` (`ID`, `question`, `difficulty`, `description`) VALUES
	...
	(5, 'Kaj od naštetega ne moremo uporabiti da lahko zagotovimo zaupnost podatkov?', 1, 'Nadzor različic nima vpliva na zaupnost podatkov. Uporabniško ime in geslo si uporabnik dodeli sam, z enkripcijo se ti podatki zašifrirajo. Z dvofaktorskim nadzorom avtentikacije zagotovimo zelo dobro varnost pred vdorom.'),
